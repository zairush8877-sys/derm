...
_DISHES = [
    ("Куриная грудка", 4.0, 1.5, 0.0),   # на грамм: белок, жир, углеводы
    ("Рис отварной", 0.25, 0.03, 0.28),
    ("Овощной салат", 0.09, 0.05, 0.06),
    ("Гречка", 0.13, 0.03, 0.25),
    ("Лосось запечённый", 0.20, 0.13, 0.0),
    ("Паста с соусом", 0.11, 0.06, 0.30),
    ("Яичница", 0.13, 0.11, 0.011),
    ("Творог 5%", 0.17, 0.05, 0.03),
    ("Банан", 0.011, 0.003, 0.23),
    ("Хлеб цельнозерновой", 0.13, 0.03, 0.43),
]
